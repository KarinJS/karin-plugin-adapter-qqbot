import { AdapterQQBotText } from '../adapter'
import { C2CMsgEvent, GroupMsgEvent } from './types'
import { karin, createGroupMessage, SrcReply, createFriendMessage } from 'node-karin'
...
export const createGroupMsg = (client: AdapterQQBotText, event: GroupMsgEvent) => {
  ...
  const srcReply: SrcReply = (elements) => client.sendMsg(contact, elements)
