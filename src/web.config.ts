  ...
  components: () => {
    ...
    return [
      ...
      components.input.create('proxy:prodApi', {
        ...
        description: '机器人使用正式环境时调用的 QQ OpenAPI 根地址。默认是官方地址；如果你有反向代理，就填写代理后的 http:// 或 https:// 地址，末尾有无 / 都可以。',
        value: proxy.prodApi,
      ...
      components.input.create('proxy:sandboxApi', {
        ...
        description: '开启“沙盒环境”后使用的 QQ OpenAPI 根地址。一般保持默认；只有需要代理沙盒接口时才修改，末尾有无 / 都可以。',
      ...
      components.input.create('proxy:tokenApi', {
        ...
        description: '用于把 AppID 和 Secret 换成 app access token。默认是 QQ 官方接口；如果正式环境 API 走代理，这里通常也要填对应的代理地址，末尾有无 / 都可以。',
      ...
      components.input.create('proxy:prodWs', {
        ...
        description: '事件接收方式选择 WebSocket，且机器人未开启沙盒时使用。支持 ws:// 和 wss://，默认已经填好官方网关地址，末尾有无 / 都可以。',
        value: proxy.prodWs,
      ...
      components.input.create('proxy:sandboxWs', {
        ...
        description: '事件接收方式选择 WebSocket，且机器人开启沙盒时使用。支持 ws:// 和 wss://，默认已经填好官方沙盒网关地址，末尾有无 / 都可以。',
