...
|op\_member\_openid|string|操作移除机器人退群的群成员 OpenID|
...
← [机器人加入群聊](/wiki/develop/api-v2/autogen/event/group_add_robot.html) [群聊消息接收开启](/wiki/develop/api-v2/autogen/event/group_msg_receive.html) →
