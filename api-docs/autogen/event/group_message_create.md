...
当机器人开启了"接收所有消息"功能后，群里的每一条消息（不限于@机器人）都会推送此事件。 各字段含义与 GROUP\_AT\_MESSAGE\_CREATE 完全一致。

## [#](#事件) 事件

|字段|值|
|---|---|
|事件名|GROUP\_MESSAGE\_CREATE|
...
← [撤回群聊消息](/wiki/develop/api-v2/autogen/api/v2_groups_group_openid_messages_message_id.delete.html) [群@机器人消息](/wiki/develop/api-v2/autogen/event/group_at_message_create.html) →
