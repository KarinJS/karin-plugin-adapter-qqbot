...
|allow\_proactive\_msg|boolean|是否接收主动推送。true: 接受主动推送|
|recv\_msg\_setting|string|接受消息的类型：群内接收消息的设置：all、only\_mention、mention\_and\_context|
...
← [获取群基本信息](/wiki/develop/api-v2/autogen/api/v2_groups_group_openid_info.get.html) [入群申请列表拉取](/wiki/develop/api-v2/autogen/api/v2_groups_group_openid_join_request_list.get.html) →
