...
|msg\_id|string|选填，要回复的消息id([Message](/wiki/develop/api-v2/server-inter/message/template/model.html#message).id), 在 [AT\_MESSAGE\_CREATE](/wiki/develop/api-v2/server-inter/channel/message/event.html#at_message_create) 事件中获取。|
...
← [群@机器人消息](/wiki/develop/api-v2/autogen/event/group_at_message_create.html) [内嵌格式](/wiki/develop/api-v2/server-inter/channel/message/format.html) →
