...
|is\_finish|uint32|是否拉取完毕(0:否；1:是)|
...
← [机器人下麦](/wiki/develop/api-v2/server-inter/channel/content/audio/delete_mic.html) [获取帖子详情](/wiki/develop/api-v2/server-inter/channel/content/forum/get_thread.html) →
