...
← [创建频道身份组](/wiki/develop/api-v2/server-inter/channel/role-group/post_guild_role.html) [删除频道身份组](/wiki/develop/api-v2/server-inter/channel/role-group/delete_guild_role.html) →
