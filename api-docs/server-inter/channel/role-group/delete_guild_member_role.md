...
← [创建频道身份组成员](/wiki/develop/api-v2/server-inter/channel/role-group/put_guild_member_role.html) [获取子频道用户权限](/wiki/develop/api-v2/server-inter/channel/role-group/channel_permissions/get_channel_permissions.html) →
