...
← [获取子频道用户权限](/wiki/develop/api-v2/server-inter/channel/role-group/channel_permissions/get_channel_permissions.html) [获取子频道身份组权限](/wiki/develop/api-v2/server-inter/channel/role-group/channel_permissions/get_channel_roles_permissions.html) →
