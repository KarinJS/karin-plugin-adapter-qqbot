...
|消息按钮|文字链|
|---|---|
|![消息按钮](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.21.0/assets/img/message-btn.94002609.jpg)|![文字链](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.21.0/assets/img/text-chain.b2f9b0fb.jpg)|
