...
如： ![错误码](https://qq-ai.cdn-go.cn/web/bot-docs/-/v1.14.0/assets/img/error.592db73d.png)
...
← [唯一身份机制](/wiki/develop/api-v2/dev-prepare/unique-id.html) [websocket](/wiki/develop/api-v2/dev-prepare/error-trace/websocket.html) →
