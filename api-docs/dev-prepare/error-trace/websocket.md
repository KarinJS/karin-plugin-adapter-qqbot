...
### [#](#针对-websocket-错误码的简单处理逻辑) 针对 websocket 错误码的简单处理逻辑

* 4009 可以重新发起 resume
* 4914，4915 不可以连接，请联系官方解封
* 其他错误，请重新发起 identify

← [openapi](/wiki/develop/api-v2/dev-prepare/error-trace/openapi.html) [发送消息](/wiki/develop/api-v2/server-inter/message/send-receive/send.html) →
